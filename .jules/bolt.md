...
## 2026-08-16 - Middleware Log Spam Optimization
...
**Action:** Use a module-level flag to ensure such warnings are logged only once, significantly improving RPS by removing excessive I/O per request.
