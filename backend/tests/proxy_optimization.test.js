...
describe('Proxy Optimization Tests', () => {
  ...
  it('should verify createProxyMiddleware is called exactly twice (during initialization, one for http and one for https)', async () => {
    ...
    // It should have been called twice during module initialization (HTTP and HTTPS)
