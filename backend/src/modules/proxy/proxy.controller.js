...
// Optimization: Move normalization to module level and replace regex with endsWith/slice
// to prevent function reallocation per request and accelerate string matching.
