...
// Optimization: Pre-compile normalize utility function
// Moved `normalize` from inside handleProxy to module level
// to avoid recreating the function and regex per request (~4.4x performance improvement).
