...
const format = winston.format.combine(
  ...
  winston.format.printf((info) => {
    if (info.level === 'http') {
      // ⚡ Bolt Optimization: Fast path for Morgan logs passed directly as top-level properties.
      // Avoids the overhead of extracting info.message and checking typeof when possible.
      ...
      // Fallbacks for older formats or manual http logs
